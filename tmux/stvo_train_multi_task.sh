...
HUGG_OUT_DIR="$DATA_DIR/STVo_PRLM_HF_hierarchical_models_20_epochs_10_segments_de"
OUT_DIR="$DATA_DIR/STVo_PRLM_PY_hierarchical_models_20_epochs_10_segments_de"
...
for BASE_MODEL in "${MASKED_MODELS[@]}"; do
        python ../finetune_multi_task_STvO_mlm_clm_clu.py \
            ...
            --clu_data_path ../data/stvo/de/main_content_Straßenverkehrs_Ordnung_graph_de_sentence_clu_dataset.json \
            --cls_data_path ../data/synthetic-data/stvo/qa_train.jsonl \
            --paragraph_embeddings_file ../legal-KGE/embeddings/transe/STvO_de/transe_paragraph_embeddings_best.json \
